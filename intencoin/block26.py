...
# CORRECCIÓN CLAVE: Intentamos leer el secreto de la variable de entorno BRIDGE_SECRET.
# Usamos "dev-bridge-secret" como valor de reserva si la variable de entorno no está establecida.
    ...
    if known_wallets:
        for wallet_addr in list(known_wallets):
            try:
                ...
                # RUTA CRÍTICA: La Wallet necesita el campo 'bridge_secret' en el payload.
                payload = {
                    "wallet": wallet_addr,
                    "symbol": "INTEN", 
