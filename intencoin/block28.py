...
def start_miner_timer():
    ...
    print("---------------------------------------------------------------------")
    print(f"Minero INTENcoin (Puerto 5002) iniciado y listo para sincronizar.")
    print(f"Para que trabaje simultáneamente, debes registrar el nodo 5001 en este nodo (5002).")
    print("---------------------------------------------------------------------")
    
    Timer(5, automated_mining).start() from flask import Flask, request, jsonify
import requests
import uuid
import time
import hashlib
