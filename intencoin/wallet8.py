...
def send_external():
    ...
    # ============================
    # CASO 1: INTEN → BTC (SWAP)
    # ============================
    # Aceptar ambos nombres de variable (del        HTML y del backend)
    
    symbol_dest = data.get("symbol_dest") or             data.get("swap_to")
    ...
    if symbol == "INTEN" and symbol_dest == "BTC":
        ...
        amount_to_send_dest = usd_value / rate_dest # BTC enviado
        ...
        add_ledger({
            "type": "external_swap",
            "spent": "INTEN",
            "spent_amount": amount_to_debit,
            "sent": "BTC",
            "sent_amount": amount_to_send_dest,
    ...
    if symbol == "BTC":
        ...
        return jsonify({
            ...
            "amount_BTC": amount_to_debit,
            "to": to_address,
            "txid": txid
        }), 200

    # ================================================
    # CASO 3: Cualquier otra cripto directa (ETH, XRP…)
    # ================================================
